...
BEGIN
	...
	BEGIN TRY
		...
		-- Insere dados limpos e padronizados na tabela crm_cust_info na Camada Silver
		...
		-- Insere dados limpos e padronizados na tabela crm_prd_info na Camada Silver
		...
		-- Insere dados limpos e padronizados na tabela crm_sales_details na Camada Silver
		...
		-- Insere dados limpos e padronizados na tabela ERP_CUST_AZ12 na Camada Silver
		...
		-- Insere dados limpos e padronizados na tabela ERP_LOC_A101 na Camada Silver
		...
		-- Insere dados limpos e padronizados na tabela ERP_PX_CAT_G1V2 na Camada Silver
		...
		PRINT '>> Duração do carregamento da Camada Silver: ' + CAST(DATEDIFF(second, @start_time, @end_time) AS NVARCHAR) + ' segundos.';
	END TRY
